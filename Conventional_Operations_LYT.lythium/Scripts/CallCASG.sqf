...
CASD setMarkerColor "colorBLUFOR" ;
CASD setMarkerAlpha 0.7;
CASD setMarkerText "CAS";
publicVariable "CASD";
...
nul = [[(getMarkerPos CASD),(0 + (random 360)),"B_Plane_CAS_01_F",2],"Scripts\CASG.sqf"] remoteExec ["BIS_fnc_execVM",2];
