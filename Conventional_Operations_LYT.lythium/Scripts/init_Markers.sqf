_objectLoc = nearestobjects [position TheCommander, ["LocationEvacPoint_F"], 33000]; 
...
_objectLoc = nearestobjects [position TheCommander, ["Land_InvisibleBarrier_F"], 33000]; 
...
_objectLoc = nearestobjects [position TheCommander, ["LocationCityCapital_F"], 33000]; 
 _objectCount = count _objectLoc;
_objectCountNew = round ( _objectCount / EnemyPrec );
if (_objectCountNew == 0) then {_objectCountNew = 1;};
_allobjectsShuffled = _objectLoc call BIS_fnc_arrayShuffle;
...
_objectLoc = nearestobjects [position TheCommander, ["LocationCity_F"], 33000]; 
 _objectCount = count _objectLoc;
_objectCountNew = round ( _objectCount / EnemyPrec );
if (_objectCountNew == 0) then {_objectCountNew = 1;};
_allobjectsShuffled = _objectLoc call BIS_fnc_arrayShuffle;
...
{if (count (nearestObjects [(getPos _x), ["Land_i_Barracks_V1_F", "Land_u_Barracks_V2_F", "Land_i_Barracks_V2_F", "Land_Barracks_01_grey_F", "Land_Barracks_01_dilapidated_F"], 1500]) > 0) then {
_Factory =  selectRandom nearestObjects [(getPos _x), ["Land_i_Barracks_V1_F", "Land_u_Barracks_V2_F", "Land_i_Barracks_V2_F", "Land_Barracks_01_grey_F", "Land_Barracks_01_dilapidated_F"], 1500]  ;
...
_objectLoc = nearestobjects [position TheCommander, ["LocationVillage_F"], 40000]; 
