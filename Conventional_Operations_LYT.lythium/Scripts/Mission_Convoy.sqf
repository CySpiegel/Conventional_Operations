...
_mrkr setMarkerAlpha 0.7 ;  
	...
	[parseText "<t color='#FF3619' font='PuristaBold' align = 'right' shadow = '1' size='3'>! WARNING !</t><br /><t  color='#FF3619'  align = 'right' shadow = '1' size='1.6'>Intel Suggests Enemy Support Convoy Incoming, ETA 10 Mikes</t>", [0, 0.5, 1, 1], nil, 13, 1.7, 0] remoteExec ["BIS_fnc_textTiles", 0];
		openMap true;
	[markerSize "ConvoyStrt", markerPos "ConvoyStrt", 1] call BIS_fnc_zoomOnArea;
	sleep 600 ;
		[parseText "<t color='#FF3619' font='PuristaBold' align = 'right' shadow = '1' size='3'>! WARNING !</t><br /><t  color='#FF3619'  align = 'right' shadow = '1' size='1.6'>Enemy Support Convoy Mobolizing To the AO,</t>", [0, 0.5, 1, 1], nil, 13, 1.7, 0] remoteExec ["BIS_fnc_textTiles", 0];
	openMap true;
	[markerSize "ConvoyStrt", markerPos "ConvoyStrt", 1] call BIS_fnc_zoomOnArea;
...
if ( ARMDIS == 0 ) then {
_nearRoad = selectRandom ( (getpos _CNV) nearRoads 200 ) ; 
V6 = createVehicle [ selectRandom East_Ground_Vehicles_Heavy, (_nearRoad getRelPos [0, 0]), [], 10, "NONE"]; 
_azimuth = (getMarkerPos "ConvoyStrt") getDir (getMarkerPos "ConvoyDest") ;
V6 setDir _azimuth;
