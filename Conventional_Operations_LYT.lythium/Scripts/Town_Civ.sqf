...
_thisTownCivTrigger = _this select 0;
...
_allBuildings = nearestObjects [(getPos _thisTownCivTrigger), ["HOUSE"], 80];   
...
[] execVM "Scripts\Civ_Relations.sqf";
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 if (_Chance > 0) then {
 _nearRoad = selectRandom ((getpos _thisTownCivTrigger) nearRoads 100 ) ; 
...
_V setDir _dir;
 ...
 _nearRoad = selectRandom ((getpos _thisTownCivTrigger) nearRoads 2000 ) ; 
_pos = _nearRoad getRelPos [6, selectRandom [90, -90]];
_V = createVehicle [selectRandom CivVehArray, [_pos select 0, _pos select 1, (_pos select 2) + 5], [], 0, "CAN_COLLIDE"]; 
_nextRoad = ( roadsConnectedTo _nearRoad ) select 0;
_dir = _nearRoad getDir _nextRoad;
...
//////////////////////////////////////////////////////////////////////////////
_all = nearestObjects [(getPos _thisTownCivTrigger), ["HOUSE"], 20];  
...
_M = [allMapMarkers,  _thisTownCivTrigger] call BIS_fnc_nearestPosition;
...
[G,_thisTownCivTrigger getPos [(0 + (random 100)), (0 + (random 350))], 90] call BIS_fnc_taskPatrol;
};
...
[G,_thisTownCivTrigger getPos [(0 + (random 100)), (0 + (random 350))], 90] call BIS_fnc_taskPatrol;
       ...
       _MMM = [_allZoneMarks,  _thisTownCivTrigger] call BIS_fnc_nearestPosition ;


if (((getMarkerPos _MMM) distance (getPos _thisTownCivTrigger)) < 1500) then {
