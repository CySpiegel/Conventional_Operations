...
_V = createVehicle [selectRandom ["Land_PowerGenerator_F", "Box_FIA_Ammo_F", "Box_Syndicate_Ammo_F", "Box_Syndicate_WpsLaunch_F", "Box_Syndicate_Wps_F", "Box_FIA_Support_F"], _Pos, [], 500, "NONE"]; 
...
execVM "Scripts\INTL_Civ.sqf"; 
 ...
 true,             
 false             
] remoteExec ["BIS_fnc_holdActionAdd", 0, ((units G) select 0)]; 
