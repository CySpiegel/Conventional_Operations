...
_SHs = nearestObjects [_thisSquadTrigger , ["HOUSE"], 1500] select {count (_x buildingPos -1) > 2};
_SH = _SHs - _NOSHs ;
_HQB = _SH select 0 ;
...
G = [_HQB getPos [(100 +(random 500)), (0 + (random 360))], East,[selectRandom East_Units]] call BIS_fnc_spawnGroup;  
