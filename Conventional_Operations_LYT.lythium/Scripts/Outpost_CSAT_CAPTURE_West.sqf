...
if (triggerActivated _thisCaptureTrigger) then {
				...
				[100, 'OUTPOST'] execVM 'Scripts\NOtification.sqf' ;
				[100] execVM 'Scripts\Reward.sqf';
				[] execVM 'Scripts\DangerPlus.sqf';
				[] execVM 'Scripts\DangerPlus.sqf';
				[thisTrigger, 2000] execVM 'Scripts\QuickRF.sqf';
				};				
		...
		[_thisCaptureTrigger] execVM 'Scripts\Outpost_CSAT_CAPTURE_West.sqf';
};				
