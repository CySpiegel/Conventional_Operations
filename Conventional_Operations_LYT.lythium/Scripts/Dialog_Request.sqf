...
if ((((typeOf player == "B_G_officer_F") or (typeOf player == F_Officer)) && (isMultiplayer)) or (!isMultiplayer) or (isServer) or ((player == TheCommander) && (serverCommandAvailable '#kick') && (serverCommandAvailable '#debug')) or ((serverCommandAvailable '#kick') && (serverCommandAvailable '#debug'))) then {
...
_FOBB = nearestObjects [position player, ["Land_Cargo_HQ_V3_F", "Land_Cargo_HQ_V1_F"], 150] select 0;
