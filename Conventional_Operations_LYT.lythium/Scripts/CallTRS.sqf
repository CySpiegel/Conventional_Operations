...
_GSHPs = nearestobjects [player,[F_Heli_03],40000] select {count (fullCrew [_x, "cargo", false]) == 0 && alive _x == true && count (waypoints group ((crew _x) select 0)) == 1 && driver _x != objNull};
