...
_GSHPs = nearestobjects [player,["B_UAV_02_dynamicLoadout_F"],40000] select {alive _x == true};
	if (count _GSHPs > 0 ) then {
		
_UAV = nearestobjects [player,["B_UAV_02_dynamicLoadout_F"],40000] select 0;
...
_UAV = createVehicle ["B_UAV_02_dynamicLoadout_F",(getMarkerpos _CASStrt), [], 0, "FLY"];
