...
FOBB = nearestObjects [position player, ["Land_Cargo_HQ_V3_F", "Land_Cargo_HQ_V1_F"], 40000];
publicVariable "FOBB";
...
if (isClass(configFile >> "CfgPatches" >> "ace_main")) then {[_x, true] remoteExec ["ace_arsenal_fnc_initBox", 0];} ;
...
_FOBT = nearestObjects [position player, ["Land_TripodScreen_01_large_sand_F", "Land_TripodScreen_01_large_F"], 40000];
