...
_thisCityCivTrigger = _this select 0;
...
_allBuildings = nearestObjects [(getPos _thisCityCivTrigger), ["HOUSE"], 150];   
...
//////Generator////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
_Houses= nearestObjects [(getPos _thisCityCivTrigger) , ["HOUSE"], 300] ;  
_OtherHouses = nearestObjects [(getPos _thisCityCivTrigger) , ["HOUSE"], 50] ; 
...
_V = createVehicle ["Land_TTowerSmall_2_F", getPos _PowerHouse, [], 0, "NONE"]; 
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 if (_Chance > 0) then {
 _nearRoad = selectRandom ((getpos _thisCityCivTrigger) nearRoads 300 ) ; 
...
_V setDir _dir;
 ...
 _nearRoad = selectRandom ((getpos _thisCityCivTrigger) nearRoads 2000 ) ; 
_pos = _nearRoad getRelPos [6, 0];
_V = createVehicle [selectRandom CivVehArray, [_pos select 0, _pos select 1, (_pos select 2) + 10], [], 0, "CAN_COLLIDE"]; 
_nextRoad = ( roadsConnectedTo _nearRoad ) select 0;
_dir = _nearRoad getDir _nextRoad;
...
_I1_WP_1 SetWaypointType "CYCLE";
 ...
 ///////////////////////////////////////////////////////////////////////////////
_all = nearestObjects [(getPos _thisCityCivTrigger), ["HOUSE"], 20];  
...
_allBuildings = nearestObjects [getPos _thisCityCivTrigger, ["HOUSE"], 200];  
_allPositions = [];  
...
_M = [allMapMarkers,  _thisCityCivTrigger] call BIS_fnc_nearestPosition;
...
[G,_thisCityCivTrigger getPos [(0 + (random 100)), (0 + (random 350))], (100 + (random 250))] call BIS_fnc_taskPatrol;
G = [selectRandom _allPositions, civilian,[selectRandom CivMenArray]] call BIS_fnc_spawnGroup;     
((units G) select 0) disableAI "all";
((units G) select 0) enableAI "MOVE";
((units G) select 0) enableAI "ANIM";
...
[G,_thisCityCivTrigger getPos [(0 + (random 100)), (0 + (random 350))], (100 + (random 250))] call BIS_fnc_taskPatrol;
       ...
       _MMM = [_allZoneMarks,  _thisCityCivTrigger] call BIS_fnc_nearestPosition ;


if (((getMarkerPos _MMM) distance (getPos _thisCityCivTrigger)) < 1500) then {
...
G = [selectRandom _allPositions, independent,[selectRandom GuerMenArray, selectRandom GuerMenArray]] call BIS_fnc_spawnGroup;     
[G,_thisCityCivTrigger getPos [(0 + (random 100)), (0 + (random 350))], 90] call BIS_fnc_taskPatrol;
...
if (_REPSCORE < 7) then {
_nearRoad = selectRandom ((getpos _thisCityCivTrigger) nearRoads 100 ) ; 
